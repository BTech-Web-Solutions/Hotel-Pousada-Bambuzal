...
export default function ChalesTriplos() {
  ...
  return (
    <>
      <Box>
        <Typography variant="h4">Chalés Triplos</Typography>
        ...
        >
          ...
          piscinas e do Rio Sana. Amplo espaço interno com cama tamanho queen
          para casal e de solteiro , colchões magnéticos com infravermelho que
          proporcionará uma noite de sono perfeita, TV a cabo com 32', frigobar,
          ar condicionado e o chuveiro com água de nascentes sendo aquecido com
          energia solar contribuindo com sustentabilidade do planeta.
        </Typography>
      </Box>
